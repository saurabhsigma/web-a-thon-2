  ...
  return (
    <DashboardLayout userRole={userRole} userName={user?.name}>
      <div className="space-y-6">
        {/* Header */}
        <div className="doodle-card bg-gradient-to-r from-amber-900 to-amber-800 border-4 border-amber-950 p-6 shadow-xl">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 rounded-full bg-yellow-400 flex items-center justify-center border-4 border-amber-950 shadow-lg">
              <FaBullhorn className="text-3xl text-amber-900" />
            </div>
            <div>
              <h1 className="text-3xl font-bold text-yellow-100">📌 School Notice Board</h1>
              <p className="text-yellow-200 font-medium">Check the latest announcements pinned here!</p>
            </div>
          </div>
        </div>
